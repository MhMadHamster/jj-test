...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bind = __webpack_require__(159);
	...
	var App = function (_Component) {
		...
		function App(props) {
			...
			var labels = [];
			props.data.map(function (news) {
				news.labels.map(function (label) {
		...
		_createClass(App, [{
			key: 'handleLabel',
			value: function handleLabel(label) {
				var _state = this.state;
				var activeLabels = _state.activeLabels;
				var visibleLabels = _state.visibleLabels;

				if (activeLabels.indexOf(label) === -1) activeLabels.push(label);else activeLabels.splice(activeLabels.indexOf(label), 1);
				if (activeLabels.length) visibleLabels = activeLabels;else visibleLabels = this.state.labels;
				this.setState({
			...
			key: 'filterNews',
			value: function filterNews(arrNews) {
				var _this2 = this;

				return arrNews.filter(function (newsItem) {
					return _this2.state.activeLabels.every(function (labelElm) {
						return newsItem.labels.includes(labelElm);
					});
				}).sort(function (a, b) {
					return _this2.state.sortFlag ? Date.parse(a.date) < Date.parse(b.date) : Date.parse(a.date) > Date.parse(b.date);
				});
			}
		}, {
			key: 'render',
			value: function render() {
				...
				var visibleNews = this.filterNews.call(this, this.state.news);
				var dateClassName = cx({
					dateSort: true,
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: _styles2.default.topBar },
						_react2.default.createElement(
							'div',
							{ onClick: this.handleSort.bind(this), className: dateClassName },
							_react2.default.createElement(
								'span',
								null,
								'Date'
						...
						_react2.default.createElement(
							'ul',
							{ className: _styles2.default.labelsList },
							this.state.labels.map(function (label, i) {
								return _react2.default.createElement(
									'li',
									{ className: _this3.state.activeLabels.indexOf(label) !== -1 ? _styles2.default.active : '', key: i, onClick: _this3.handleLabel.bind(_this3, label) },
									label
								);
							})
						)
					),
					visibleNews.map(function (news, i) {
						return _react2.default.createElement(
							'div',
							{ key: i, className: _styles2.default.news },
							_react2.default.createElement(
								'div',
								{ className: _styles2.default.date },
								news.date.substr(8, 2),
								'/',
								news.date.substr(5, 2),
								_react2.default.createElement(
									'span',
									{ className: _styles2.default.year },
									news.date.substr(0, 4)
								)
							),
							_react2.default.createElement(
								'div',
								{ className: _styles2.default.newsContent },
								_react2.default.createElement(
									'h2',
									null,
									news.title
	...
	_reactDom2.default.render(_react2.default.createElement(App, { data: someJson }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules!./../../node_modules/postcss-loader/index.js!./styles.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules!./../../node_modules/postcss-loader/index.js!./styles.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*! normalize.css v3.0.3 | MIT License | github.com/necolas/normalize.css */\r\n\r\nimg, legend {\r\n\tborder: 0;\r\n}\r\n\r\nlegend, td, th {\r\n\tpadding: 0;\r\n}\r\n\r\nhtml {\r\n\tfont-family: sans-serif;\r\n\t-ms-text-size-adjust: 100%;\r\n\t-webkit-text-size-adjust: 100%;\r\n}\r\n\r\nbody {\r\n\tmargin: 0;\r\n}\r\n\r\narticle, aside, details, figcaption, figure, footer, header, hgroup, main, menu, nav, section, summary {\r\n\tdisplay: block;\r\n}\r\n\r\naudio, canvas, progress, video {\r\n\tdisplay: inline-block;\r\n\tvertical-align: baseline;\r\n}\r\n\r\naudio:not([controls]) {\r\n\tdisplay: none;\r\n\theight: 0;\r\n}\r\n\r\n[hidden], template {\r\n\tdisplay: none;\r\n}\r\n\r\na {\r\n\tbackground-color: transparent;\r\n}\r\n\r\na:active, a:hover {\r\n\toutline: 0;\r\n}\r\n\r\nabbr[title] {\r\n\tborder-bottom: 1px dotted;\r\n}\r\n\r\nb, optgroup, strong {\r\n\tfont-weight: 700;\r\n}\r\n\r\ndfn {\r\n\tfont-style: italic;\r\n}\r\n\r\nh1 {\r\n\tfont-size: 2em;\r\n\tmargin: .67em 0;\r\n}\r\n\r\nmark {\r\n\tbackground: #ff0;\r\n\tcolor: #000;\r\n}\r\n\r\nsmall {\r\n\tfont-size: 80%;\r\n}\r\n\r\nsub, sup {\r\n\tfont-size: 75%;\r\n\tline-height: 0;\r\n\tposition: relative;\r\n\tvertical-align: baseline;\r\n}\r\n\r\nsup {\r\n\ttop: -.5em;\r\n}\r\n\r\nsub {\r\n\tbottom: -.25em;\r\n}\r\n\r\nsvg:not(:root) {\r\n\toverflow: hidden;\r\n}\r\n\r\nfigure {\r\n\tmargin: 1em 40px;\r\n}\r\n\r\nhr {\r\n\tbox-sizing: content-box;\r\n\theight: 0;\r\n}\r\n\r\npre, textarea {\r\n\toverflow: auto;\r\n}\r\n\r\ncode, kbd, pre, samp {\r\n\tfont-family: monospace,monospace;\r\n\tfont-size: 1em;\r\n}\r\n\r\nbutton, input, optgroup, select, textarea {\r\n\tcolor: inherit;\r\n\tfont: inherit;\r\n\tmargin: 0;\r\n}\r\n\r\nbutton {\r\n\toverflow: visible;\r\n}\r\n\r\nbutton, select {\r\n\ttext-transform: none;\r\n}\r\n\r\nbutton, html input[type=button], input[type=reset], input[type=submit] {\r\n\t-webkit-appearance: button;\r\n\tcursor: pointer;\r\n}\r\n\r\nbutton[disabled], html input[disabled] {\r\n\tcursor: default;\r\n}\r\n\r\nbutton::-moz-focus-inner, input::-moz-focus-inner {\r\n\tborder: 0;\r\n\tpadding: 0;\r\n}\r\n\r\ninput {\r\n\tline-height: normal;\r\n}\r\n\r\ninput[type=checkbox], input[type=radio] {\r\n\tbox-sizing: border-box;\r\n\tpadding: 0;\r\n}\r\n\r\ninput[type=number]::-webkit-inner-spin-button, input[type=number]::-webkit-outer-spin-button {\r\n\theight: auto;\r\n}\r\n\r\ninput[type=search] {\r\n\t-webkit-appearance: textfield;\r\n\tbox-sizing: content-box;\r\n}\r\n\r\ninput[type=search]::-webkit-search-cancel-button, input[type=search]::-webkit-search-decoration {\r\n\t-webkit-appearance: none;\r\n}\r\n\r\nfieldset {\r\n\tborder: 1px solid silver;\r\n\tmargin: 0 2px;\r\n\tpadding: .35em .625em .75em;\r\n}\r\n\r\ntable {\r\n\tborder-collapse: collapse;\r\n\tborder-spacing: 0;\r\n}\r\n\r\nbody {\r\n\tfont-family: 'PT Sans', sans-serif;\r\n\tfont-size: 14px;\r\n}\r\n\r\n._7zgDciGI8f34VqoVNWHap {\r\n\twidth: 800px;\r\n\tmargin: 30px auto;\r\n}\r\n\r\n.pz3XOHBkl8KUEnuzO9GxW {\r\n\tdisplay: -webkit-box;\r\n\tdisplay: -webkit-flex;\r\n\tdisplay: -ms-flexbox;\r\n\tdisplay: flex;\r\n}\r\n\r\n._1uG_l0axHh_m-vd3xZ6pg5 {\r\n\tdisplay: -webkit-box;\r\n\tdisplay: -webkit-flex;\r\n\tdisplay: -ms-flexbox;\r\n\tdisplay: flex;\r\n\t-webkit-box-flex: 0;\r\n\t-webkit-flex: 0 0 50px;\r\n\t    -ms-flex: 0 0 50px;\r\n\t        flex: 0 0 50px;\r\n\theight: 46px;\r\n\tfont-size: 16px;\r\n\tline-height: 16px;\r\n\tcolor: #fff;\r\n\tbackground-color: #4183D7;\r\n\ttext-align: center;\r\n\tbox-sizing: border-box;\r\n\tpadding: 5px 10px 25px;\r\n\toverflow: hidden;\r\n\tposition: relative;\r\n\tcursor: pointer;\r\n\t-webkit-user-select: none;\r\n\t   -moz-user-select: none;\r\n\t    -ms-user-select: none;\r\n\t        user-select: none;\r\n}\r\n\r\n._1uG_l0axHh_m-vd3xZ6pg5 span {\r\n\tposition: relative;\r\n\tz-index: 1;\r\n}\r\n\r\n._1uG_l0axHh_m-vd3xZ6pg5:before, ._1uG_l0axHh_m-vd3xZ6pg5:after {\r\n\tcontent: '';\r\n\twidth: 15px;\r\n\theight: 15px;\r\n\t-webkit-transform: rotate(45deg);\r\n\ttransform: rotate(45deg);\r\n\tposition: absolute;\r\n\tleft: 0;\r\n\tright: 0;\r\n\tmargin: auto;\r\n}\r\n\r\n._1uG_l0axHh_m-vd3xZ6pg5:before {\r\n\tbackground-color: #fff;\r\n\tbottom: 3px;\r\n}\r\n\r\n._1uG_l0axHh_m-vd3xZ6pg5:after {\r\n\tbackground-color: #4183D7;\r\n\tbottom: -2px;\r\n}\r\n\r\n._1uG_l0axHh_m-vd3xZ6pg5._27JgpiUrsZxQuDje2Zwjqi {}\r\n\r\n._1uG_l0axHh_m-vd3xZ6pg5._27JgpiUrsZxQuDje2Zwjqi:before {\r\n\tbottom: 9px;\r\n}\r\n\r\n._1uG_l0axHh_m-vd3xZ6pg5._27JgpiUrsZxQuDje2Zwjqi:after {\r\n\tbottom: 14px;\r\n}\r\n\r\n._3iYFrKCJ0CrpKzvXKxiQQ7 {\r\n\tdisplay: -webkit-box;\r\n\tdisplay: -webkit-flex;\r\n\tdisplay: -ms-flexbox;\r\n\tdisplay: flex;\r\n\t-webkit-box-flex: 1;\r\n\t-webkit-flex: 1 1 auto;\r\n\t    -ms-flex: 1 1 auto;\r\n\t        flex: 1 1 auto;\r\n\t-webkit-flex-wrap: wrap;\r\n\t    -ms-flex-wrap: wrap;\r\n\t        flex-wrap: wrap;\r\n\tmargin: 10px 0;\r\n\tpadding-left: 20px;\r\n}\r\n\r\n._3iYFrKCJ0CrpKzvXKxiQQ7 li {\r\n\tdisplay: -webkit-box;\r\n\tdisplay: -webkit-flex;\r\n\tdisplay: -ms-flexbox;\r\n\tdisplay: flex;\r\n\t-webkit-box-flex: 0;\r\n\t-webkit-flex: 0 1 auto;\r\n\t-ms-flex: 0 1 auto;\r\n\tflex: 0 1 auto;\r\n\tpadding: 5px 10px;\r\n\tbackground-color: #fff;\r\n\tborder: 1px solid #4183D7;\r\n\tborder-radius: 15px;\r\n\tmargin-right: 10px;\r\n\t-webkit-user-select: none;\r\n\t-moz-user-select: none;\r\n\t-ms-user-select: none;\r\n\tuser-select: none\r\n}\r\n\r\n._3iYFrKCJ0CrpKzvXKxiQQ7 li._1iwjUi3SLz3ddrEjAWplPg, ._3iYFrKCJ0CrpKzvXKxiQQ7 li:hover {\r\n\tcolor: #fff;\r\n\tbackground-color: #4183D7;\r\n\tcursor: pointer;\r\n}\r\n\r\n.hxz05tpOgOrk2RIcDJCDu ._2e79ughyniFrSYXsGXaBio {\r\n\tdisplay: inline-block;\r\n\twidth: 50px;\r\n\tvertical-align: top;\r\n\tmargin-top: 15px;\r\n\ttext-align: center;\r\n\tpadding-top: 5px;\r\n\tbox-sizing: border-box;\r\n\tcolor: #fff;\r\n\tbackground-color: #4183D7;\r\n}\r\n\r\n.hxz05tpOgOrk2RIcDJCDu ._2e79ughyniFrSYXsGXaBio span._1tziy9g4cCNWIzHIlS0g7C {\r\n\tdisplay: block;\r\n\twidth: 100%;\r\n\tpadding: 5px;\r\n\tmargin-top: 5px;\r\n\tbox-sizing: border-box;\r\n\tbackground-color: #446CB3;\r\n\tcolor: #fff;\r\n}\r\n\r\n.hxz05tpOgOrk2RIcDJCDu .uM25l1jfyaWuijQwEjhuX {\r\n\tdisplay: inline-block;\r\n\twidth: 750px;\r\n\tbox-sizing: border-box;\r\n\tpadding-left: 25px;\r\n}\r\n\r\n.hxz05tpOgOrk2RIcDJCDu .uM25l1jfyaWuijQwEjhuX h2 {\r\n\ttext-transform: uppercase;\r\n\tfont-weight: normal;\r\n\tmargin: 10px 0 0;\r\n}\r\n\r\n.hxz05tpOgOrk2RIcDJCDu .uM25l1jfyaWuijQwEjhuX p {\r\n\tmargin: 5px 0;\r\n}\r\n", ""]);

	// exports
	exports.locals = {
		"container": "_7zgDciGI8f34VqoVNWHap",
		"topBar": "pz3XOHBkl8KUEnuzO9GxW",
		"dateSort": "_1uG_l0axHh_m-vd3xZ6pg5",
		"desc": "_27JgpiUrsZxQuDje2Zwjqi",
		"labelsList": "_3iYFrKCJ0CrpKzvXKxiQQ7",
		"active": "_1iwjUi3SLz3ddrEjAWplPg",
		"news": "hxz05tpOgOrk2RIcDJCDu",
		"date": "_2e79ughyniFrSYXsGXaBio",
		"year": "_1tziy9g4cCNWIzHIlS0g7C",
		"newsContent": "uM25l1jfyaWuijQwEjhuX"
	};
